...
/**
 * The self-defined Tuple class
 * @author jz699 JUNCHEN ZHAN
 *
 */
public class Tuple {
 
	private long[] list; // they array contains the data, which is a long integer.
	...
	public Tuple(String s){
		String[] temp = s.split(",");
		list = new long[temp.length];
		for(int i=0;i<temp.length;i++)
			list[i] = Long.parseLong(temp[i]);
	}
