...
public class Parser {
	 ...
	 */
	public static void handle(PlainSelect ps, String s, int index, int temp1, int temp2){
		if(temp2==0){
			BTreeBuilder bt = new BTreeBuilder();
			bt.dump();
			return;
		}
		...
		PhysicalPlanBuilder ppb = new PhysicalPlanBuilder
				(temp,ps,map,grid[0][0],grid[0][1],grid[1][0],grid[1][1],temp1);
