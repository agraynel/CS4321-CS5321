...
public class Interpreter {
	 ...
	 */
	public Statement getLine(int index, int temp1, int temp2){
		...
		try{
			if((state = parser.Statement())!=null){
				...
				Parser.handle(ps,outputdir,index,temp1,temp2);
	 ...
	 */
	public void dump(int temp1, int temp2){
		while(getLine(index,temp1,temp2)!=null){
	...
	public static void main(String[] args){
		...
		try{
			...
			tree = Integer.parseInt(fread.readLine());
			query = Integer.parseInt(fread.readLine());
