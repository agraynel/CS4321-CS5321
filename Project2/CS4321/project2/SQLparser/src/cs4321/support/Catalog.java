...
public class Catalog {
	...
	private static final String base = "C:/Users/messfish/Documents/CS4321/samples/input/db/data/";
	private static final String scheme = "C:/Users/messfish/Documents/CS4321/samples/input/db/scheme.txt";
	...
	private Catalog(){
		...
		String s;
		try{
			FileReader file = new FileReader(scheme);
		    BufferedReader br = new BufferedReader(file);
		    while((s = br.readLine())!=null){
		    	String[] str = s.split("\\s+");
		    	map.put(str[0], base+str[0]);
		    	schema = new HashMap<>();
